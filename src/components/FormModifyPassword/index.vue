      ...
      <el-row :gutter="20">
        ...
        <el-col :span="24">
          <el-row class="no-scroll flex-box" type="flex" justify="end">
            <el-button type="primary" size="" :plain="true" @click="onCancel(false)"> 取消 </el-button>
            <el-button type="primary" size="" @click="onSave()"> 保存 </el-button>
          </el-row>
        </el-col>
      </el-row>
    </el-form>
  ...
  methods: {
    ...
    onSave() {
      this.$refs.formModifyPassword.validate((valid) => {
        ...
        SystemController.changePassword(this, params)
          .then((res) => {
