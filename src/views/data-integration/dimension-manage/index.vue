      ...
      <div class="main">
        ...
        >
          ...
          <template #slot-operate="{ scope }">
            ...
            <el-button type="primary" link @click="dimensionController.handleDelete(scope?.row).then(() => {})">
...
import DefinitionDimensionController from '@/core/classes/DefinitionDimensionController/index'
...
const dimensionController = new DefinitionDimensionController()
...
function selectMenu(node) {
  ...
  dimensionController.getListByNode(node)
}
